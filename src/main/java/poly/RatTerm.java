...
public final class RatTerm {
  ...
  public double eval(double d) {
    ...
    if(this.isNaN()){
      ...
      double value =Math.pow(d,this.expt)*this.coeff.doubleValue();
      checkRep();
      return value;
    }
  }
  ...
  public RatTerm negate() {
    ...
    if (this.isNaN()) {
      ...
      RatTerm negTerm = new RatTerm(coeff.negate(), expt);
      checkRep();
      return negTerm;
    }
  }
  ...
  public RatTerm add(RatTerm arg) {
    ...
    if ((this.expt != arg.expt) && (!this.isNaN() && !this.isZero()) &&
      ...
      return NaN;
        ...
        RatTerm argZeroCaseTerm= new RatTerm(this.coeff, this.expt);
        checkRep();
        return argZeroCaseTerm;
    } else if (this.isZero()) {
        RatTerm thisZeroCaseTerm =new RatTerm(arg.coeff, arg.expt);
        checkRep();
        return thisZeroCaseTerm;}
    else {
      RatTerm normalCaseTerm=new RatTerm(this.coeff.add(arg.coeff), this.expt);
      checkRep();
      return normalCaseTerm;
    }
  }
  ...
  public RatTerm sub(RatTerm arg) {
    ...
    if ((this.expt != arg.expt) && (!this.isNaN() && !this.isZero()) &&
      ...
      RatTerm afterSubTerm = add(arg.negate());
      checkRep();
      return afterSubTerm;
    }
  }
  ...
  public RatTerm mul(RatTerm arg) {
    ...
    if (arg.isNaN() || this.isNaN()) {
      ...
      RatTerm afterMulTerm = new RatTerm(this.coeff.mul(arg.coeff), this.expt + arg.expt);
      checkRep();
      return afterMulTerm;
    }
  }
  ...
  public RatTerm div(RatTerm arg) {
    ...
    if (arg.isZero() || arg.isNaN() || this.isNaN()) {
      ...
      RatTerm afterDivTerm = new RatTerm(this.coeff.div(arg.coeff), this.expt - arg.expt);
      checkRep();
      return afterDivTerm;
    }
  }
  ...
  public RatTerm differentiate() {
      ...
      if (this.isNaN()) {
          ...
          RatTerm afterDiffTerm = new RatTerm(this.coeff.mul(new RatNum(this.expt)), this.expt - 1);
          checkRep();
          return afterDiffTerm;
      }
  }
  ...
  public RatTerm antiDifferentiate() {
      ...
      if (this.isNaN()) {
          ...
          RatTerm afterantiDiffTerm =new RatTerm(this.coeff.div(new RatNum(this.expt + 1)), this.expt + 1);
          checkRep();
          return afterantiDiffTerm;
      }
  }
